        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                noch weitere Filter einstellen um ein noch genaueres Resultat zu erhalten.</p>
                    ...
                    <form action="index.php" method="get" href="#ergebnisse">
                            ...
                            if($ges_artBez =="Alle"){
                                ...
                                if ($ges_jahrVon <= $jahr && $jahr <= $ges_jahrBis &&
                                    ...
                                    if($jaStimmen>$neinStimmen){
                                        ...
                                        echo "<br>";
                                        echo "Stimmbeteiligung: ".$stimmbeteiligung."%";
                                        $count++;
                                    }else{
                                        echo "Ergebnis: ABGELEHNT mit ".(100-$jaStimmenProz)."% Nein-Stimmen von ".$gueltigeStimmen." gültigen Stimmen";
                                        echo "<br>";
                                        echo "Stimmbeteiligung: ".$stimmbeteiligung."%";
                                        $count++;
                                    }
